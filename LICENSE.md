Based on which license you have purchased from [Themesberg.com](https://themesberg.com) and is available in your account will be relevant for this copy of code.

## Freelancer License (Formerly known as Personal license)

The Freelancer License grants you, the purchaser, an ongoing, non-exclusive, worldwide license to make use of the digital work (*Item*) you have selected. Read the rest of this license for the details that apply to your use of the Item.
...
For an Item that is a template, the End Product is a customised implementation of the Item. For example: the item is a website template and the end product is the final website customised with your content.

For other types of Item, an End Product is a work that incorporates the Item as well as other things, so that it is larger in scope and different in nature than the Item. For example: the item is an UI Kit and the end product is a website.
...
This license applies in conjunction with the Themesberg Terms and Conditions. If there is an inconsistency between this license and the Terms and Conditions, this license will apply to the extent necessary to resolve the inconsistency.
...
Themesberg retains ownership of the Item but grants you the license on these terms. This license is between Themesberg and you.

## Company License (Formerly known as Developer License)

The Company License grants you, the purchaser, an ongoing, non-exclusive, worldwide license to make use of the digital work (Item) you have selected. Read the rest of this license for the details that apply to your use of the Item.

You are licensed to use the Item to create multiple End Products for yourself or for clients, and the End Product may be Sold.

An End Product is one of the following things, both requiring an application of skill and effort.

For an Item that is a template, the End Product is a customised implementation of the Item.

For example: the item is a website template and the end product is the final website customised with your content.
...
For example: the item is an UI Kit and the end product is a website.
...
This license is a “multi-use” license and not a “single application” license, which means that you can use the Item to create more than one unique End Product.

You can’t re-distribute the Item as stock, in a tool or template, or with source files. You can’t do this with an Item either on its own or bundled with other items. You can’t re-distribute or make available the Item as-is or with superficial modifications.
...
The Company License allows you to create unlimited End Products you want and deploy them on how many domains like endproduct1.com, endproduct2.com, endproductx.com.
This license allows you access to the product's designer files.

## Enterprise License

The Enterprise License grants you, the purchaser, an ongoing, non-exclusive, worldwide license to make use of the digital work (Item) you have selected. Read the rest of this license for the details that apply to your use of the Item.
...
The Enterprise License allows you to create unlimited End Products you want and deploy them on how many domains like endproduct1.com, endproduct2.com, endproductx.com.
This license allows you access to the product's designer files.